...
?>
 ...
 <section class = postfilmes>
    <div class="titulopost">Extraordinário</div> 
    <div class="capafilme">
        <img src="https://br.web.img2.acsta.net/pictures/17/11/28/18/32/3262971.jpg" alt="" class="filmes">
    </div>
    <div class =textopost>Auggie Pullman é um garoto que nasceu com uma deformação facial. Pela primeira vez, ele irá frequentar uma escola regular, como qualquer outra criança. No quinto ano, ele irá precisar se esforçar para conseguir se encaixar em sua nova realidade
    </div>
    <div class="clear"></div>
        </div>
 ...
 <div id="iframeContainer" class="playfilme">
        <iframe src="https://streamtape.com/e/Qel6WxdwO0f06pB/" width="800" height="600" frameborder="0" allowfullscreen></iframe>
 </div>
<br> <br><br> <br><br> <br>
</div>  
