...
?>
 ...
 <section class = postfilmes>
    <div class="titulopost">JOHN WICK 4: BABA YAGA</div> 
    <div class="capafilme">
        <img src="https://m.media-amazon.com/images/M/MV5BMDExZGMyOTMtMDgyYi00NGIwLWJhMTEtOTdkZGFjNmZiMTEwXkEyXkFqcGdeQXVyMjM4NTM5NDY@._V1_SX300.jpg" alt="" class="filmes">
    </div>
    <div class =textopost>Com o preço por sua cabeça cada vez maior, John Wick leva sua luta contra
         a alta mesa global enquanto procura os jogadores mais poderosos do submundo, de Nova York a Paris, de Osaka a Berlim.</div>
    <div class="clear"></div>
        </div>
 ...
 <div id="iframeContainer" class="playfilme">
        <iframe src="https://streamtape.com/e/drryPLvMAysk6oK" width="800" height="600" frameborder="0" allowfullscreen></iframe>
