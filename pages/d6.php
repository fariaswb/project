...
?>
 ...
 <section class = postfilmes>
    <div class="titulopost">Palmer</div> 
    <div class="capafilme">
        <img src="https://br.web.img3.acsta.net/pictures/20/12/18/10/24/4751126.jpg" alt="" class="filmes">
    </div>
    <div class =textopost>Após 12 anos na prisão, Eddie Palmer volta para casa para reconstruir sua vida. Ele cria uma ligação inesperada com Sam, um rapaz marginalizado que vem de uma família problemática e, agora, o passado de Eddie ameaça arruinar a sua nova vida.
    </div>
    <div class="clear"></div>
        </div>
 ...
 <div id="iframeContainer" class="playfilme">
        <iframe src="https://streamtape.com/e/WP6vbV1QROhbaaq/" width="800" height="600" frameborder="0" allowfullscreen></iframe>
 </div>
<br> <br><br> <br><br> <br>
</div>  
