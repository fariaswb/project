...
?>
 ...
 <section class = postfilmes>
    <div class="titulopost">GENTE GRANDE</div> 
    <div class="capafilme">
        <img src="https://images.filmesnocinema.com.br/covers/gente-grande.jpg" alt="" class="filmes">
    </div>
    <div class =textopost>A morte do treinador de basquete da infância de velhos amigos os reúne no mesmo lugar que celebraram um 
        campeonato anos atrás. Os amigos, acompanhados de suas esposas e filhos, descobrem que idade não significa o mesmo que maturidade.
    </div>
    <div class="clear"></div>
        </div>
 ...
 <div id="iframeContainer" class="playfilme">
        ...
        <iframe src="https://streamtape.com/e/ml7RMk2X9JFbYxL/" width="800" height="600" frameborder="0" allowfullscreen></iframe>
 </div>
<br> <br><br> <br><br> <br>
</div>  
