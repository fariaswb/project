...
?>
 ...
 <section class = postfilmes>
    <div class="titulopost">AS BRANQUELAS</div> 
    <div class="capafilme">
        <img src="https://br.web.img3.acsta.net/medias/nmedia/18/97/52/82/20534159.jpg" alt="" class="filmes">
    </div>
    <div class =textopost>O que acontece quando dois atrapalhados agentes do FBI se disfarçam de princesas mega-ricas para se infiltrarem na alta sociedade? 
        O resultado é situações extremamente engraçadas e diversão total ao ver 
        estes dois irmãos azarados transformando-se em duas senhoritas refinadas e com estilo!
    </div>
    <div class="clear"></div>
        </div>
 ...
 <div id="iframeContainer" class="playfilme">
        <iframe src="https://streamtape.com/e/28a4Q20QQbHZvz0/" width="800" height="600" frameborder="0" allowfullscreen></iframe>
 </div>
<br> <br><br> <br><br> <br>
</div>  
